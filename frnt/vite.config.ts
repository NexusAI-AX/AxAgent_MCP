...
... // Contents unchanged for brevity in this excerpt
`;

const FRONTEND_PLUGINS = [react()]; // plus any other existing plugins
  ...
  (function llamaCppPlugin() {
    ...
    return {
      ...
      writeBundle() {
        ...
        // 🔥 Method 1: place gzip right next to dist/index.html
