...
interface AppContextValue {
  ...
  showCanvasPyInterpreter: boolean;
  setShowCanvasPyInterpreter: (show: boolean) => void;
...
export const AppContextProvider = ({
  ...
  const [showCanvasPyInterpreter, setShowCanvasPyInterpreter] = useState(false);
