...
export default function ChatScreen() {
  ...
  // 캔버스 표시 여부는 canvasData와 showCanvasPyInterpreter 상태에 따라 결정됩니다.
  const hasCanvas = !!canvasData && (canvasData.type !== CanvasType.PY_INTERPRETER || showCanvasPyInterpreter);
  ...
  return (
    ...
    >
      ...
      <div className="w-full sticky top-[7em] h-[calc(100vh-9em)]">
        {canvasData?.type === CanvasType.PY_INTERPRETER && showCanvasPyInterpreter && (
          <McpServerConfig />
        )}
      </div>
    </div>
